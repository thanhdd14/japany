...
gulp.task("ejs", function (done) {
    ...
    for (var i = 0; i < page_data.length; i++) {
        ...
        if (bread1 != "") {
            BREADCRUMBS = '<a href="/">ホーム</a> <span>' + bread1 + '</span>'
        }
        if (bread2 != "") {
            BREADCRUMBS = '<a href="/">ホーム</a> <span><a href="' + bread1_url + '">' + bread1 + '</a></span> <span>' + bread2 + '</span>'
        }
        if (bread3 != "") {
            BREADCRUMBS = '<a href="/">ホーム</a> <span><a href="' + bread1_url + '">' + bread1 + '</a></span> <span><a href="' + bread2_url + '">' + bread2 + '</a></span> <span>' + bread3 + '</span>'
        }
        if (bread4 != "") {
            BREADCRUMBS = '<a href="/">ホーム</a> <span><a href="' + bread1_url + '">' + bread1 + '</a></span> <span><a href="' + bread2_url + '">' + bread2 + '</a></span> <span><a href="' + bread3_url + '">' + bread3 + '</a></span> <span>' + bread4 + '</span>'
        }
        if (parentId4 != "") {
